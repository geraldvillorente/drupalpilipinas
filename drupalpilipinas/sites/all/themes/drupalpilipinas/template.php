 ...
 */
function drupalpilipinas_preprocess_maintenance_page(&$variables, $hook) {
  // When a variable is manipulated or added in preprocess_html or
  // preprocess_page, that same work is probably needed for the maintenance page
  // as well, so we can just re-use those functions to do that work here.
  drupalpilipinas_preprocess_html($variables, $hook);
  drupalpilipinas_preprocess_page($variables, $hook);
}
 ...
 */
function drupalpilipinas_preprocess_html(&$variables, $hook) {
 ...
 */
function drupalpilipinas_preprocess_node(&$variables, $hook) {
  $variables['sample_variable'] = t('Lorem ipsum.');
